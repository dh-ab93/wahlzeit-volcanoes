...
public class CoordinateTest {
	...
	public void testCartesianDistance() {
		try {
			...
			Coordinate c5 = new CartesianCoordinate(limit, limit, limit);
			Coordinate c6 = new CartesianCoordinate(-limit, -limit, -limit);
			Coordinate c7 = new SphericCoordinate(limit, 0.0, 0.0);
